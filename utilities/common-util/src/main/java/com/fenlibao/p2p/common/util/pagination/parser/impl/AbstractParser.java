...
import com.fenlibao.p2p.common.util.pagination.Dialect;
import com.fenlibao.p2p.common.util.pagination.parser.SqlParser;
...
//		return sqlParser.getSmartCountSql(sql);
	...
	private Map<Object, Object> convertToMap(Object object) {
	...
	public Map<Object, Object> setPageParameter(MappedStatement ms, Object parameterObject,
		...
		if (parameterObject == null) {
			...
			paramMap = convertToMap(parameterObject);
		} else {
			paramMap = new HashMap<Object, Object>();
