...
import com.fenlibao.p2p.common.util.pagination.MSUtils;
...
public class PageDynamicSqlSource implements SqlSource, Constant {
	...
	public PageDynamicSqlSource(MSUtils msUtils, Configuration configuration,
	...
	public BoundSql getBoundSql(Object parameterObject) {
		...
		if (count) {
			sqlSource = msUtils.getStaticCountSqlSource(configuration,
					sqlSource, parameterObject);
		} else {
			sqlSource = msUtils.getStaticPageSqlSource(configuration,
					sqlSource, parameterObject);
		}
