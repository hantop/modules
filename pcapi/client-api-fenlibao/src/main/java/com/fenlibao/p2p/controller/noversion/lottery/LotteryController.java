...
public class LotteryController {
    ...
    HttpResponse getLotteryPrizes(@ModelAttribute BaseRequestForm paramForm,
		...
		if(lotteryActivityInfo == null || lotteryActivityInfo.getActivityId() == 0){
    ...
    HttpResponse getLotteryUserAvailTimes(HttpServletRequest request,
		...
		LotteryActivityInfo lotteryActivityInfo = lotteryActivityService.getLotteryActivityInfo(activityCode);
		int activityId = lotteryActivityInfo.getActivityId();
		UserLotteryTimes userLotteryTimes = lotteryPrizeService.getUserLotteryTimes(Integer.valueOf(userId), activityId);
		int availTimes = userLotteryTimes==null?0:userLotteryTimes.getAvailTimes();
    ...
    HttpResponse lotteryDrawPrize(@ModelAttribute BaseRequestForm paramForm,
		...
		LotteryPrizeInfo drawPrizeInfo = lotteryPrizeService.lottery(activityId, Integer.valueOf(userId), cellTailNumber);
		LotteryPrizeInfoVO lotteryPrizeInfoVO = new LotteryPrizeInfoVO();
	 ...
	 *获取2017春节活动信息
	 */
	@RequestMapping(value = "/user/draw/lotterySpringFestival2017Info", method = RequestMethod.GET)
	HttpResponse lotterySpringFestival2017Info(@ModelAttribute BaseRequestForm paramForm) throws Exception {
	...
	public HttpResponse activityRedpacketList(String userId,String token,BaseRequestForm baseRequestForm
	) {
		HttpResponse apiResponse = new HttpResponse();
		//参数验证
		if(!baseRequestForm.validate()){
