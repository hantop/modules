 ...
 * @date 2016年3月25日
 */
@RestController("v_1_0_0/MallController")
@RequestMapping("mall")
public class MallController {
	 ...
	 * @return
	 */
	@RequestMapping(value = "commodity", method = RequestMethod.GET, headers = APIVersion.V_1_0_0)
	 ...
	 * @return
	 */
	@RequestMapping(value = "consume/patterns", method = RequestMethod.GET, headers = APIVersion.V_1_0_0)
