        ...
        try {
            ...
            if (dbDataTable == null) {
                response.setCodeMessage(
                        ResponseEnum.RESPONSE_DBFILE_TYPE_NO_EXISTS.getCode(),
                        ResponseEnum.RESPONSE_DBFILE_TYPE_NO_EXISTS.getMessage());
            } else {
            ...
            response.setCodeMessage(
                    ResponseEnum.RESPONSE_INTERAL_SEVER_ERROR.getCode(),
                    "创建sqliteDB文件失败");
        }
        return response;
    }
