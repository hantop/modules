 ...
 * @date 2016年2月18日
 */
@RestController("v_1_0_0/MobileTopUpController")
@RequestMapping("trade/topup")
public class MobileTopUpController {
	 ...
	 * @throws Exception 
	 */
	@RequestMapping(value = "mobile", method = RequestMethod.POST, headers = APIVersion.V_1_0_0)
	public HttpResponse mobile(BaseRequestFormExtend params, 
		...
		try {
			...
			if(!Validator.isMobile(phoneNum)){
				response.setCodeMessage(ResponseCode.ACTIVITY_PHONE_REG_NOT_RIGHT);
				return response;
			}
	 ...
	 * @return
	 */
	@RequestMapping(value = "parvalue", method = RequestMethod.GET, headers = APIVersion.V_1_0_0)
	public HttpResponse getParvalue(BaseRequestForm params,@RequestParam(required = false, value = "rechargeType") String rechargeType) {
		HttpResponse response = new HttpResponse();
	 ...
	 * @param dealPassword  交易密码,必填
	 * 
	 * 
	 * @return HttpResponse
	 */
	@RequestMapping(value = "mobile/yishang", method = RequestMethod.POST, headers = APIVersion.V_1_0_0)
	public HttpResponse yishang(BaseRequestFormExtend params,
			String phoneNum, String parvalueCode,String integralCode,String integralQty,String dealPassword) {       
		HttpResponse response = new HttpResponse();
	 ...
	 * @return
	 */
	@RequestMapping(value = "mobile/yishang/record", method = RequestMethod.POST, headers = APIVersion.V_1_0_0)
