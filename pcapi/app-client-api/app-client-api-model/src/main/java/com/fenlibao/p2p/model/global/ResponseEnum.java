...
public enum ResponseEnum {
    ...
    RESPONSE_PHONE_CAPTCHA_MAXTIME("10081", "验证码发送次数超限，请明日再试"),
    RESPONSE_PHONE_CAPTCHA_FREQUENTLY("10091", "验证码发送太频繁，请稍后再试"),
    RESPONSE_OPENTICHET_INVALID("10101", "未获取到openticket"),
    RESPONSE_OPENTICKET_MISMATCH("10111", "openticket不匹配"),
    RESPONSE_OPENTICKET_EXPIRED("10121", "openticket过期"),
    RESPONSE_PHONE_HALFOUR_MAXTIME("10131", "验证码发送太频繁，请半小时后再试"),
    RESPONSE_PHONE_HOUR_MAXTIME("10141", "验证码发送太频繁，请1小时后再试"),
    ...
    NAME_LENGTH_TOO_LONG("40107","昵称长度过长"),
    SCHOOLE_LENGTH_TOO_LONG("40108","毕业学校长度过长"),
    POSITION_LENGTH_TOO_LONG("40109","职位长度过长"),
