...
public interface WithdrawDao {
	 ...
	 * @return
	 */
	BigDecimal getWithdrawFreezeSum(String userId);
	 ...
	 * @return
	 */
	 BigDecimal getWithdrawFreezeSumByDepository(String userId);
	 ...
	 * @return
	 */
	BigDecimal getCGWithdrawFreezeSum(Integer userId,String cgMode);
}
