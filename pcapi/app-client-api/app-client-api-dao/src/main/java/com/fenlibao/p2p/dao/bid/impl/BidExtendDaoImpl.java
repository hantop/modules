...
public class BidExtendDaoImpl implements BidExtendDao {
    ...
    @Override
    public BigDecimal getTenderFreezeSumByDepository(String userId,String depository) {
        Map<String,Object> map = new HashMap<String,Object>();
        map.put("depository", depository);
        map.put("userId", userId);
        return sqlSession.selectOne(MAPPER + "getTenderFreezeSumByDepository", map);
    }
    ...
    public List<InvestRecordsVO> getBidInvestRecords(String bidId, PageBounds pageBounds) {
        Map<String,Object> map = new HashMap<String,Object>();
        map.put("bidId", bidId);
        return sqlSession.selectList(MAPPER + "getBidInvestRecords", map, pageBounds);
