...
public class BidExtendServiceImpl implements BidExtendService {
    ...
    @Override
    public List getBidInvestRecords(String bid, String timestamp, String isUp) throws Exception {
        return null;
    }
...
//            }
//            investsList =  bidExtendDao.getBidInvestRecords(Integer.parseInt(bid.trim()));
//
