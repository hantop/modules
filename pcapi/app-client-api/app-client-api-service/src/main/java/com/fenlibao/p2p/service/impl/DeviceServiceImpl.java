...
public class DeviceServiceImpl implements DeviceService {
    ...
    @Override
    public List<AdImageVo> getAdimgList(String screenTypeId, String clientTypeId,String advertType,String versionType,int versionTypeEnum) {
