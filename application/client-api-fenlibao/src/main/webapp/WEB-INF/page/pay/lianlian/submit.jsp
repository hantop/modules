...
<div class="header">
    ...
    <h1 class="logo">Just a test, please don't mind</h1>
...
<section>
    <div class="form_warp">
        <form id="pay_form" action="https://wap.lianlianpay.com/authpay.htm" method="post">
            <ul>
                <li id="post_data"></li>
            </ul>
        </form>
...
<script type="text/javascript">
    $('#next_btn').click(function () {
        ...
        var data = {
            ...
            userId: 19, isBind: 0,
            version: '2.0.0', deviceId: 1, clientType: 5, screenType: 1, token: 123
        };
        $.ajax({
            url: '<%=request.getContextPath()%>/lianlianPay/recharge',
            data: data,
            type: 'post',
            dataType: 'json',
