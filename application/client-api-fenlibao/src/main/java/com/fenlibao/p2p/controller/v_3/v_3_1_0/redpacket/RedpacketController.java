package com.fenlibao.p2p.controller.v_3.v_3_1_0.redpacket;
...
@RestController("v_3_1_0/RedpacketController")
@RequestMapping(value = "redpacket", headers = APIVersion.v_3_1_0)
public class RedpacketController {
    ...
    public HttpResponse share(BaseRequestFormExtend params, String bidId, int itemType) {
        ...
        try {
            ...
            InviteUrlInfoVO_131 inviteUrlVO = tenderShareService.addTenderShare(userId,Integer.valueOf(bidId),0);
