package com.fenlibao.p2p.controller.v_4.v_4_2_0.notice;
...
/** 媒体报道
 */
@RestController("v_4_2_0/ArticleController")
@RequestMapping(value = "info", headers = APIVersion.v_4_2_0)
public class ArticleController {
    ...
    HttpResponse getArticleList(HttpServletRequest request,
                                @ModelAttribute BaseRequestForm paramForm, Integer pageNo, Integer pagesize,String type) throws Exception{
		...
		try{
			...
			List<Article> infoList = noticeService.getArticleListNew(pageNo,pagesize,type);
