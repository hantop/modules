package com.fenlibao.p2p.controller.v_3.v_3_1_0.coupon;
...
@RestController("v_3_1_0/CouponController")
@RequestMapping(value = "coupons", headers = APIVersion.v_3_1_0)
public class CouponController {
    ...
    public HttpResponse getAddinterestList(BaseRequestFormExtend params,
                                Integer page,Integer limit,Integer bidId, Integer planId) {
        HttpResponse response = new HttpResponse();
    ...
    public HttpResponse getCouponsCount(BaseRequestFormExtend params, Integer bidId, Integer planId) {
        HttpResponse response = new HttpResponse();
        if (!params.validate() ) {
            response.setCodeMessage(ResponseCode.EMPTY_PARAM);
            return response;
