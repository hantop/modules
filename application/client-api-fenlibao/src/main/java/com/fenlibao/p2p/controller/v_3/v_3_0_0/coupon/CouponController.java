package com.fenlibao.p2p.controller.v_3.v_3_0_0.coupon;
...
@RestController("v_3_0_0/CouponController")
@RequestMapping(value = "coupons", headers = APIVersion.v_3_0_0)
public class CouponController {
    ...
    public HttpResponse getAddinterestList(BaseRequestFormExtend params,
                                Integer page,Integer limit,Integer bidId) {
        HttpResponse response = new HttpResponse();
        if (!params.validate() || bidId==null) {
            response.setCodeMessage(ResponseCode.EMPTY_PARAM);
            return response;
        }
