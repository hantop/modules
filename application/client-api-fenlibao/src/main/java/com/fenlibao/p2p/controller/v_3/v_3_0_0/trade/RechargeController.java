 ...
 * @date 2015年8月17日
 */
@RestController("v_3_0_0/RechargeController")
...
public class RechargeController extends AbstractLianLianPayController {
	...
	public HttpResponse getLimitList(BaseRequestForm params, String bankCode) {
		...
		List<PaymentLimitVO> limitVOList = rechargeService.getLimitList(bankCode, null);
