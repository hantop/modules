package com.fenlibao.p2p.controller.v_3.v_3_1_0.client;
...
@RestController("v_3_1_0/DeviceController")
@RequestMapping(value = "device", headers = APIVersion.v_3_1_0)
public class DeviceController {
     ...
     * @return
     */
    @RequestMapping(value = "advert/image", method = RequestMethod.GET)
    HttpResponse adImg(HttpServletRequest request,@ModelAttribute BaseRequestForm paramForm,
        ...
        try {
            ...
            List<AdImageVo> list = this.deviceService.getAdimgList(paramForm.getScreenType(), paramForm.getClientType(),advertType,version);
