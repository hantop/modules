package com.fenlibao.p2p.controller.v_4.v_4_0_0.mp;
 ...
 * @date 2016年2月18日
 */
@RestController("v_4_0_0/MobileTopUpController")
@RequestMapping(value = "trade/topup", headers = APIVersion.v_4_0_0)
...
//        	}
	...
	public HttpResponse yishang(BaseRequestFormExtend params,
			String phoneNum, String parvalueCode,String integralCode,String integralQty, String versionType) {
		HttpResponse response = new HttpResponse();
		...
		try {
			...
			versionType = (StringUtils.isEmpty(versionType) ? "PT" : versionType);
			// modify by zeronx 2017-08-29 增加存管版判断
			// 存管版
			if (VersionTypeEnum.CG.getCode().equals(versionType)) {
				try {
					XinwangUserInfo xinwangUserInfo = xwUserInfoService.queryUserInfo(UserRole.INVESTOR.getCode() + params.getUserId());
					if (xinwangUserInfo == null || StringUtils.isEmpty(xinwangUserInfo.getBankcardNo())) {
