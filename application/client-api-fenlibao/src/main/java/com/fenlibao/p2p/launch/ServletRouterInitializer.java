...
import com.fenlibao.p2p.launch.filter.VersionControllerFilter;
import com.fenlibao.p2p.launch.filter.XSSFilter;
...
import static com.fenlibao.p2p.util.umeng.UmengConfig.loadUmeng;
...
//            authFilter.addMappingForServletNames(EnumSet.allOf(DispatcherType.class), true, SPRING_SERVLET_NAME);
            ...
            xssFilter.addMappingForUrlPatterns(EnumSet.of(DispatcherType.REQUEST), true, "/*");
