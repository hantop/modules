...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <ol class="breadcrumb">
                <li class="active"><a href="${path}/finance/index">返现券成本详情</a></li>
                <li class="active"><b>返现券</b></li>
            </ol>
            <form id="dataform" class="form-inline" method="post" action="${path}/finance/returncash/detail">
...
<script type="text/javascript">
    ...
    function exportUserUsedReturncashs(obj){
        ...
        $(cloneForm).attr('action', '${path}/finance/returncash/detail/export').submit();
        return false;
    }
</script>