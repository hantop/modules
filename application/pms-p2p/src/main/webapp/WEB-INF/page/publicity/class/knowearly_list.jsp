...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <ol class="breadcrumb">
                <li class="active"><a href="#">风险早知道</a></li>

            </ol>
            <div>
                <form id="dataform" class="form-inline" method="post" action="${path}/publicity/class/riskKnowEarlyList">
                    <input type="hidden" id="page" name="page">
                    <input type="hidden" id="fromPage" name="fromPage" value="true">

                    <div class="form-group">
                        <label>文章标题</label>
                        <input type="text" class="form-control input-sm" name="title" value="${knowEarly.title}">
                    </div>


                    <div class="form-group">
                        <label>&nbsp; 发布者</label>
                        <input type="text" class="form-control input-sm" name="publisherId"  value="${knowEarly.publisherId}">
                    </div>
                    ...
                    <div class="form-group">
                        <select class="form-control"  name="status" >
                            <option value="-1" <c:if test="${knowEarly.status == -1}">selected="selected"</c:if> >全部</option>
                    ...
                    <shiro:hasPermission name="knowEarly:edit">
                         <a class="btn btn-success btn-sm" href="${path}/publicity/class/toUpateKnowEarly?id=-1">新增</a>
                    </shiro:hasPermission>
                    <shiro:hasPermission name="knowEarly:delete">
            ...
            <div class="table-responsive">
                <table id="datatable" class="table table-striped table-bordered table-condensed">
                    ...
                    <c:forEach items="${knowEarlyList}" var="v" varStatus="vs">
                        <tr>
                            ...
                            <td>
                                ...
                                <shiro:hasPermission name="knowEarly:edit">
                                <a href="${path}/publicity/class/toUpateKnowEarly?id=${v.id}">修改</a>
                                </shiro:hasPermission>
            ...
            callback: function (result) {
                if (result) {
                    $.ajax({
                        ...
                        type : "POST",
                        data : {ids:ids},
                        url : "${path}/publicity/class/deleteKnowEarly?timestamp=" + new Date().getTime(),
                        async : true,
                        dataType :"json",
                        error : function() {
