    ...
    <div class="row">
        <div class="col-md-12">
            <ol class="breadcrumb">
                ...
                <li class="active"><a href="${path}/reward/red-packet/back-voucher-list">加息劵管理</a></li>
                <li class="active"><b>加息劵编辑</b></li>
            </ol>
            <form:form class="form-inline" method="post" action="${path}/reward/coupon/coupon-type-list" id="dataform" commandName="redPacket">
                <%-- <shiro:hasPermission name="cashBackVoucherEdit:create"> --%>
                <div class="form-group">
                    <a class="btn btn-info" href="${path}/reward/coupon/coupon-type-edit"
                       role="button">添加加息劵类型</a>
                </div><br/>
                <%-- </shiro:hasPermission> --%>
                
                <%-- <shiro:hasPermission name="cashBackVoucherEdit:search"> --%>
                <div class="form-group">
                    <label>加息券代码: </label><form:input path="activityCode" cssClass="form-control input-sm" maxlength="30"/>
