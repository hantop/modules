...
public class WithdrawExecutor extends OrderExecutorImpl {
	...
	@Override
    protected void doConfirm(Connection connection, int orderId, Map<String, String> params,OperationTypeEnum operationTypeEnum)
        throws Throwable
    {
        try
        {
            ...
            //这里暂时这样
            String content = String.format("尊敬的用户：您于%s提交的提现已成功，到账%s元，手续费%s元，请您注意查收。感谢您对我们的关注与支持。",
