...
public interface BankService {
     ...
     * @return
     */
    List<Map<String, Object>> buildBankCardsResult(List<BankCard> bankCards,int versiongControl);
     ...
     * @return
     */
    List<Map<String, Object>> getBankCardsByUserId(int userId,int versiongControl) throws Throwable;
