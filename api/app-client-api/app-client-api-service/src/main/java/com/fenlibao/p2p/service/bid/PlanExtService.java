...
public interface PlanExtService {
    ...
    void useRedPackets(int orderId, List<UserRedPacketInfo> userRedPacketInfos, int planId, int planRecordId, UserInfo userInfo, String fxhbIds, String investType, VersionTypeEnum versionTypeEnum) throws Exception;
