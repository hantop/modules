...
public interface IBidDmService extends BaseDmService{
     ...
     * @param bidType
     * @param planFlag
     * @param operationTypeEnum 投标方式
     * @return
     * @throws Throwable
     */
    public Map<String, String> doBid(Connection connection, final int bidId, final BigDecimal amount, final int accountId, String experFlg, String bidType, boolean planFlag, OperationTypeEnum operationTypeEnum)  throws Throwable;
}
