...
public interface IFundsService {
	 ...
	 * @throws Exception
	 */
	int transfer(int userId, BigDecimal amount, FeeType feeType,
	 ...
	 * @throws Exception
	 */
	int insertFundsflowRecord(int fundsAccountId, int relativelyAccountId, int tradeTypeId, BigDecimal income,
	 ...
	 * @throws Exception
	 */
	int unlockUserSDZHBalance(int userId, BigDecimal amount, FeeType feeType, VersionTypeEnum versionType) throws Exception;
	 ...
	 * @throws Exception
	 */
	int platformTransfer(int userId, BigDecimal amount, FeeType feeType,
