...
public abstract class AbstractOrderExecutor extends BaseAbstractService implements AutoCloseable {
	 ...
	 * @param orderId
	 * @param params
	 * @param isAutoBid 是否自动投标
	 * @param checkAmountFlag 是否检查最小投资额
	 * @param isSetLetter 是否发站内信
     * @return
     * @throws Throwable
     */
	public Throwable confirmKernel(Connection connection, int orderId, Map<String, String> params, boolean isAutoBid, boolean checkAmountFlag, boolean isSetLetter, OperationTypeEnum operationTypeEnum) throws Throwable {
		// 锁订单
		Throwable exception = null;
		...
		if (order != null) {
			...
			Savepoint businessSavepoint = connection.setSavepoint();
			try {
				doConfirm(connection, orderId, params, isAutoBid, checkAmountFlag, isSetLetter, operationTypeEnum);
			} catch (Throwable e) {
				exception = e;
				connection.rollback(businessSavepoint);
				// 异常处理
	...
	public void confirm(int orderId, Map<String, String> params, boolean isAutoBid) throws Throwable {
		// 锁订单
		Connection connection = null;
		Throwable exception = null;
		Map<String,Object> fxhbMap = null;
		try{
			connection = DbPoolConnection.getInstance().getConnection();
			connection.setAutoCommit(false);// 打开事务
			exception = confirmKernel(connection, orderId, params, isAutoBid, true, !isAutoBid, null);
			connection.commit();
		}catch (Throwable t){
			connection.rollback();
			exception = t;
	...
	//protected abstract void doConfirm(Connection connection, int orderId, Map<String, String> params, boolean isAutoBid) throws Throwable;
	protected abstract void doConfirm(Connection connection, int orderId, Map<String, String> params, boolean isAutoBid, boolean checkAmountFlag, boolean isSetLetter) throws Throwable;
	protected abstract void doConfirm(Connection connection, int orderId, Map<String, String> params, boolean isAutoBid, boolean checkAmountFlag, boolean isSetLetter, OperationTypeEnum operationTypeEnum) throws Throwable;
