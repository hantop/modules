...
public interface RedpacketService {
     ...
     * @param tradeType
     */
    void grantRedPackets(int orderId, List<UserRedPacketInfo> userRedPacketInfos, String userId, String phoneNum, int tradeType, VersionTypeEnum versionTypeEnum) throws Exception;
