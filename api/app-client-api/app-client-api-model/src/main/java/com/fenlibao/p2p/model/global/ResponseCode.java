...
////公用错误码(10xxx) start
    ...
    COMMON_GOTO_CG("21001", "为了您的账户资金可靠，请前往存管版操作"), //停用普通版接口
    COMMON_GOTO_CG2("21002", "按监管要求，请前往存管版操作"),
...
////公用错误码 end
    ...
    USER_RISK_UNTEST("311118","根据《网络借贷信息中介机构业务活动管理暂行办法》要求，为加强网络借贷的监督管理、防范资金风险，请出借人完成风险测试后再进行出借。"),
...
////微信公众号相关错误码  end
    ...
    ACTIVITY_GIVE_PRIZE_ERROR("214116","抽奖失败，给予指定奖品"),
    ACTIVITY_MISS_PRIZE_ERROR("214117","抽奖失败，奖品信息丢失"),
////营销活动相关错误码  end
    ...
    BID_FULLED("220308", "该项目已满额，请出借其他项目"),
    ...
    ZQZR_PASSEDEARNING_UNDER_ZERO("223010","债权已过天数利息不能小于0"),
    ...
    TCJH_IS_NOVICEBID("223116","新手标,不能退出"),
    ZQZR_IS_XFXD("223116","消费信贷标,不能转让"),
    ZQZR_IS_DOWN("223117","当前没有需要平台购买的随时退出标债权"),
    TCJH_COTAIN_NOT_REPAYMENT("223108","组合中含有未回款的标，该组合不可退出"),
    ZQZR_BUY_FAIL("223118", "购买债权失败，请联系客服400-930-5559"),
    ZQZR_CLOSE("223119", "抱歉，已停止提供该项服务"),

    FT_ZQ_NOT_FOUND("123109","找不到债权对应的用户组合"),
    ...
    //出借分享 end
    //出借定向标
    BID_DIRECTIONAL_TOTAL_USER_ASSETS("324306","定向标只限符合条件的用户出借"),
    //出借随时退出标
...
////其他 end
    MOVE_AMOUNT_FIND("300001","资金迁移金额必须大于零"),
    MOVE_AMOUNT_USERINFO_FIND("100002","更新账户资金失败"),
    MOVE_AMOUNT_WLZH_BLANCE_FIND("100003","往来账户资金小于迁移资金"),
    MOVE_AMOUNT_SDZH_BLANCE_FIND("100004","锁定账户资金小于迁移资金"),
    MOVE_RECHARGE_FIND("100005","新网代充值失败"),
    XW_RECHARGEACCOUNT_BALANCE_FIND("400006","新网代充值账户余额不足"),
    //资金迁移功能暂停
    MOVE_AMOUNT_UNABLE("300004","由于操作资金迁移用户数量过多，导致服务器爆满，现需暂时停用并升级资金迁移功能，具体恢复时间请留意平台公告！给您带来的不便，敬请谅解!"),
