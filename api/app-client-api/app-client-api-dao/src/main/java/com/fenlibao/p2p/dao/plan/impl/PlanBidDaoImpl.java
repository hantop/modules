...
public class PlanBidDaoImpl implements PlanBidDao {
    ...
    @Override
    public void addMarketSetting(Integer productId, Integer targetUser, BigDecimal totalUserAssets, BigDecimal userInvestingAmount, BigDecimal userAccumulatedIncome, Integer productType) {
        Map<String, Object> params = new HashMap<>();
        params.put("productId", productId);
        params.put("productType", productType);
        params.put("targetUser", targetUser);
        params.put("totalUserAssets", totalUserAssets);
        params.put("userInvestingAmount", userInvestingAmount);
        params.put("userAccumulatedIncome", userAccumulatedIncome);
        sqlSession.insert(MAPPER + "addMarketSetting", params);
    }

    @Override
    public void addProductLabel(Integer productId, String label, String comment, Integer type) {
        Map<String, Object> params = new HashMap<>();
        params.put("productId", productId);
        params.put("productType", type);
        params.put("label", label);
        params.put("comment", comment);
        sqlSession.insert(MAPPER + "addProductLabel", params);
    }

    @Override
    public void updateBidsRate(Map<String, Object> bidRates) {
        sqlSession.update(MAPPER + "updateBidsRate", bidRates);
    }

    @Override
    public BigDecimal getRateManageRatio() {
        return sqlSession.selectOne(MAPPER + "getRateManageRatio");
    }
}
