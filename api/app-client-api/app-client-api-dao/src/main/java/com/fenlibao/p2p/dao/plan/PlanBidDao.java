...
public interface PlanBidDao {
    ...
    /**
     * 插入营销设置
     * @param productId 计划或标的id
     * @param targetUser
     * @param totalUserAssets 用户资产总额
     * @param userInvestingAmount 用户在投金额
     * @param userAccumulatedIncome 用户累计收益
     * @param productType 产品类型(1:计划 2:标的)
     */
    void addMarketSetting(Integer productId, Integer targetUser, BigDecimal totalUserAssets, BigDecimal userInvestingAmount, BigDecimal userAccumulatedIncome,  Integer productType);
     ...
     * @param productType 产品类型(1:计划 2:标的)
     */
    void addProductLabel(Integer productId, String label, String comment, Integer productType);

    void updateBidsRate(Map<String, Object> bidRates);

    BigDecimal getRateManageRatio();
}
