package com.fenlibao.p2p.util.umeng;
    ...
    private void loadProperties() {
        ...
        try {
            input = new InputStreamReader(
                    UmengConfig.class.getClassLoader().getResourceAsStream(CONFIG_PROPERTIES), "UTF-8");
            props.load(input);
        } catch (Exception e) {
            e.printStackTrace();
        } finally {
