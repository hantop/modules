package com.fenlibao.lianpay.api;

/**
 * Created by LouisWang on 2015/8/22.
 */
...
public class HttpRequestSimple{
    private static final Logger log = LogManager.getLogger(HttpRequestSimple.class);
    ...
    public String postSendJson(String url, String body)
    {
        if (url == null || "".equals(url))
        {
            log.error("request url is empty.");
