 ...
 * 
 */
public class BidInfoVoWDZJ extends BaseBidInfoVo<BidInfoVoWDZJ> {
	...
	public BidInfoVoWDZJ(BidInfoEntity bid) throws Throwable {
		super(bid);
	...
	List<BidInvestrecordsVoWDZJ> subscribes;
	...
	public List<BidInvestrecordsVoWDZJ> getSubscribes() {
		return subscribes;
	}

	public void setSubscribes(List<BidInvestrecordsVoWDZJ> subscribes) {
