...
import com.fenlibao.p2p.model.xinwang.enums.account.IdCardType;
...
import com.fenlibao.p2p.service.xinwang.account.XWResetPasswordService;
 ...
 */
@Service
public class XWResetPasswordServiceImpl implements XWResetPasswordService{
    ...
    @Transactional
    @Override
    public Map<String, Object> getResetPasswordRequestData(ResetPasswordRequestParams params) throws Exception {
        ...
        Map<String, Object> sendData = XinWangUtil.gatewayRequest(XinwangInterfaceName.RESET_PASSWORD.getCode(),reqData);

        //create order
        XWRequest req=new XWRequest();
        req.setInterfaceName(XinwangInterfaceName.RESET_PASSWORD.getCode());
