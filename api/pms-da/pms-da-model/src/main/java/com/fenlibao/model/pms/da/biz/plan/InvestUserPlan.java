...
public class InvestUserPlan {
    ...
    private BigDecimal freezeAmount;//存管冻结金额

    public InvestUserPlan() {
    }

    public InvestUserPlan(int id, int userId, int planId, BigDecimal investAmount, BigDecimal beinvestAmount, int status, Timestamp exitTime, Timestamp createTime, Timestamp updateTime) {
        this.id = id;
        this.userId = userId;
        this.planId = planId;
